...
DEFAULT_TYPES = [
    ...
    },
    {
        "name": "event",
        "display_name": "イベント",
        "description": "予定されている出来事や発生した出来事",
        "fields_schema": [
            ...
            {"name": "status", "type": "string", "description": "実施状況 (done/canceled/planed)"},
            {"name": "result", "type": "string", "description": "実施結果を簡潔に文章で"},
            {"name": "type", "type": "string", "description": "イベントタイプ(meeting/release/incidentなど)"},
    ...
    },
    {
        "name": "organization",
        "display_name": "組織",
        "description": "企業、チーム、グループなど",
        "fields_schema": [
            {"name": "name", "type": "string", "description": "organization名"},
            {"name": "type", "type": "string", "description": "組織タイプ(company/team/clubなど)"},
            {"name": "relation", "type": "string", "description": "組織と自分との関係(joined/coworker/customerなど)"}
        ],
    },
    {
        "name": "project",
        "display_name": "プロジェクト",
        "description": "複数のタスク、イベント、目標、アイデアを束ねる活動単位",
        "fields_schema": [
            {"name": "status", "type": "string", "description": "状態 (planning/active/paused/completed/archived)"},
            {"name": "start_date", "type": "date", "description": "開始日"},
            {"name": "due_date", "type": "date", "description": "期限"},
            {"name": "members", "type": "ref", "ref_type": "person", "multiple": True, "description": "関係者のアイテムID"},
        ],
    },
    {
        "name": "idea",
    ...
    },
    {
        "name": "note",
        "display_name": "ノート",
        "description": "既存タイプに自然に収まらないメモ、知識、記録",
        "fields_schema": [

...
DEFAULT_TYPES = [
    ...
    },
    {
        "name": "memo",
        "display_name": "メモ",
        "description": "技術メモ、TIL、調査結果などの記録",
        "fields_schema": [
            {"name": "memo_type", "type": "string", "description": "種別 (til/investigation/troubleshooting/reference/note)"},
            {"name": "tags", "type": "string", "description": "タグ（カンマ区切り）"},
            {"name": "source_url", "type": "string", "description": "参照元URL"},
            {"name": "related_project", "type": "ref", "ref_type": "project", "description": "関連プロジェクトのアイテムID"},
        ],
    },
    {
